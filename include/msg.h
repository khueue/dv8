 ...
 * and idiomatic to avoid dangling pointers:
 *
 *   msg = msg_alloc();
 *   ... use msg ...
 *   msg = msg_free();
 ...
 * set() copies the given string into the message data and sets the message's
 *   data type to string
 ...
 * set() copies the given integer into the message data and sets the message's
 *   data type to integer
 * get() returns the integer data of the message, or 0 if the data type is not
 *   integer
 */
